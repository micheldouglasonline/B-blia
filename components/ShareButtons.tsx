...
export const ShareButtons: React.FC<ShareButtonsProps> = ({ url }) => {
  ...
  return (
    <div className="flex items-center gap-4">
      ...
      <a href={facebookShareUrl} target="_blank" rel="noopener noreferrer" aria-label="Compartilhar no Facebook" className="hover:text-amber-100 transition-colors">
        <FacebookIcon className="w-6 h-6" />
      </a>
      <a href={instagramUrl} target="_blank" rel="noopener noreferrer" aria-label="Abrir Instagram" className="hover:text-amber-100 transition-colors">
